...
var MasterState = {
  ...
  initialize: function initialize() {
    ...
    this.projectNameInput.addEventListener('change', function (event) {
      _this.projectTitle = event.target.value;
    });
  }
...
var ControlFunctions = {
  ...
  append: function append(nodeType) {
    ...
    */
    ...
    if (_MasterState2.default.nodeIdx > -1) {
  ...
  saveProject: function saveProject() {
    ...
    if (!_MasterState2.default.saveProjectWindowIsOpen) {
      ...
      fetch('/api/projects', {
        ...
        body: JSON.stringify({
          user_id: _MasterState2.default.userID,
          title: _MasterState2.default.projectTitle,
          data: JSON.stringify(_MasterState2.default.nodes)
        })
      }).then(function (res) {
        return res.json();
...
window.onload = function () {
  _MasterState2.default.initialize();
